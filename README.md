...
示例：
```bash
  wget -4 -O fix-ssh-root.sh https://raw.githubusercontent.com/NiuStar/vps_docker/refs/heads/main/fix-ssh-root.sh && chmod +x ./fix-ssh-root.sh && bash fix-ssh-root.sh --allow-password
```
其他用法
```
